...
import { useCustomTypes } from 'transformer/hooks/useCustomTypes';
            ...
            <DropdownMenuContent className="w-auto">
              ...
              >
                <Button
                  ...
                  variant={'ghost'}
                  size={'icon'}
                  className="self-end opacity-20 hover:opacity-100 hover:text-destructive"
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-0.5">
                    ...
                    <ButtonGroup className="ml-1">
                      <DecrementDimButton vIndex={fieldIndex} tIndex={index} />
                      <IncrementDimButton vIndex={fieldIndex} tIndex={index} />
                    </ButtonGroup>
                  </div>
                </div>
                <CommandList>
